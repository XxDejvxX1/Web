  ...
  cards: [
    {
      ...
      alt: "An illustrated pipeline running from a launching rocket and dashboard down through research, tooling, analytics and security stages",
    },
    {
      id: "interfaces",
      icon: "layers",
      ...
      alt: "An illustrated design editor showing rulers, a selected element with exact position and size, spacing values and a corner-radius control",
    },
    {
      id: "code",
      icon: "code",
      ...
      alt: "An illustrated code editor beside a performance gauge, wired to a processor with cloud, database and analytics nodes",
    },
    {
      id: "care",
      icon: "shield",
      ...
      alt: "An illustrated workspace of wireframes, a completed checklist, colour swatches and drafting tools",
    },
  ],
} as const;
